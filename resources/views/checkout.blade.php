                    ...
                    <div class="card-body mb-4">
                        <div class="table-responsive">
                            ...
                            <form method="POST">
                                ...
                                <div class="row">
                                    <div class="col mt-2">
                                        <div class="form-group">
                                            <input type="text" disabled value="wanda">
                                        </div>
                                    </div>
                                    <div class="col mt-2">
                                        <div class="form-group">
                                            <input type="text" disabled value="0822743820178">
                                        </div>
                                    </div>
                                    <div class="col mt-2">
                                        <select class="form-floating" name="id_ongkir" id="">
                                            <option selected hidden value="">Pilih Ongkos kirim</option>
                                ...
                                <button class="btn btn-primary mt-4 mb-4" name="checkout">Checkout</button>
                            </form>
                        </div>
                    </div>
                </div>
