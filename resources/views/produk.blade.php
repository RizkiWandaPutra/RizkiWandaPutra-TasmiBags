                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-2 mb-3">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" id="floatingInput"
                                                                    placeholder="Nama Kamu" name="nama_menu" required>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-floating mb-3">
                                                                ...
                                                                <label for="floatingInput">Masukkan No Hp</label>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                ...
                                <!-- Akhir Modal Beli -->
                                <div class="tumbnail">
                                    <img src="img/produk/92399-air force 1.png" alt=""
                                    ...
                                    <div class="caption">
                                        ...
                                        <a href="proses/prosesbeli.php?id=" class="btn btn-primary">Beli</a>
                                    </div>
                                </div>
                            </div>
