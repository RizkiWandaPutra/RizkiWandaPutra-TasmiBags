                    ...
                    <div class="card-body mb-4">
                        <div class="row">
                            <div class="col-sm-6" style="text-align: center;">
                                ...
                                <h6 style="margin-top:30px;">tasmibags@gmail.com</h6>
                                <h6>+628097355437</h6>
                            </div>
                            <div class="col-sm-6" style="text-align: center;">
                                <h3 style="margin-top:40px;">Follow</h3>
                                <h6 style="margin-top:30px;"><i class="bi bi-facebook"></i> Tasmi Bags Shop</h6>
                                <h6><i class="bi bi-instagram"></i> Tasmi_Bags</h6>
                            </div>
                        </div>
                    </div>
                </div>
